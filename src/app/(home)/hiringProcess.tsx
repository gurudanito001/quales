    ...
    <section className="py-14 bg-neutral px-5 xl:px-28">
      ...
      <div className="flex flex-col lg:flex-row mt-14">
        ...
        <div className="flex justify-around w-full">
          <div className="w-44 sm:w-56 xl:w-full max-w-72 h-full flex flex-col items-center bg-base p-4 xl:p-12 rounded-3xl mb-5 shadow mx-auto">
          ...
          <div className="w-auto flex items-center justify-center">
            <ArrowLongRightIcon className="text-primary w-8" />
          </div>
          ...
          <div className="w-44 sm:w-56 xl:w-full max-w-72 h-full flex flex-col items-center bg-base p-4 xl:p-12 rounded-3xl mb-5 shadow mx-auto">
            <span className="w-20 h-20 md:w-28 md:h-28 flex items-center bg-white rounded-full">
              <Image src="/images/list.svg" className="mx-auto w-10 h-10 md:w-14 md:h-14" width={50} height={50} objectFit="contain" alt="Calendar Icon" />
            </span>
            {/* <ArrowLongRightIcon className="text-primary w-8 relative -mr-96 -ml-20 hidden lg:block" /> */}
        ...
        <div className="flex w-full">
          ...
          <div className="w-44 sm:w-56 xl:w-full max-w-72 h-full flex flex-col items-center bg-base p-4 xl:p-12 rounded-3xl mb-5 shadow mx-auto">
            <span className="w-20 h-20 md:w-28 md:h-28 flex items-center bg-white rounded-full">
              <Image src="/images/contract.svg" className="mx-auto w-10 h-10 md:w-14 md:h-14" width={50} height={50} objectFit="contain" alt="Calendar Icon" />
            </span>
            <h6 className="text-primary mt-4 text-center font-semibold">Sign Contract</h6>
            <p className="text-primary mt-5 lg:mt-3 text-center text-xs md:text-sm font-light">Formalize your partnership with a clear and comprehensive contract.</p>
          </div>
          ...
          <div className="w-44 sm:w-56 xl:w-full max-w-72 h-full flex flex-col items-center bg-base p-4 xl:p-12 rounded-3xl mb-5 shadow mx-auto">
            <span className="w-20 h-20 md:w-28 md:h-28 flex items-center bg-white rounded-full">
              <Image src="/images/suitcase.svg" className="mx-auto w-10 h-10 md:w-14 md:h-14" width={50} height={50} objectFit="contain" alt="Calendar Icon" />
            </span>

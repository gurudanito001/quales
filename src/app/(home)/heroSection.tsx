      ...
      <div className="h-full bg-overlay flex items-center content-center">
        <article className="relative z-10 w-full text-white text-center mx-auto lg:mb-32 opacity-100 px-3 md:px-5">
          ...
          <div className="flex gap-2 md:gap-5">
            <button className="btn text-xs md:text-xl glass rounded-full px-9 font-light text-white ml-auto">Explore Talents</button>
            <button className="btn text-xs md:text-xl bg-white text-primary font-light rounded-full px-9 mr-auto">Hire Talents</button>
          </div>
        </article>
      </div>
    </section>

    ...
    <section className="bg-white px-5 xl:px-28 pt-10 mb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8">
          <Link href="/articles/the-role-of-automation-in-quality-assurance-tools-and-techniques">
            <figure className="w-full h-40 shadow-md bg-[url('/images/role-of-automation.webp')] bg-no-repeat bg-contain bg-center flex items-center content-center rounded-lg"></figure>
          ...
          <Link href="/articles/the-shift-from-manual-to-automated-testing-challenges-and-solutions">
            <figure className="w-full h-40 shadow-md bg-[url('/images/shift-from-manual.webp')] bg-no-repeat bg-contain bg-center flex items-center content-center rounded-lg"></figure>
          ...
          <Link href="/articles/testing-in-devops-how-qa-engineers-can-keep-up-with-the-speed-of-continuous-integration">
            <figure className="w-full h-40 shadow-md bg-[url('/images/testing-in-devops.webp')] bg-no-repeat bg-contain bg-center flex items-center content-center rounded-lg"></figure>
          ...
          <Link href="/articles/who-is-a-scrum-master">
            <figure className="w-full h-40 shadow-md bg-[url('/images/who-is-a-scrum-master.webp')] bg-no-repeat bg-contain bg-center flex items-center content-center rounded-lg"></figure>

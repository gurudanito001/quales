...
const Article1 = () => {
  return (
    <Link className="flex flex-col" href="/articles/the-role-of-automation-in-quality-assurance-tools-and-techniques">
      <Image className="w-full max-h-48 object-cover rounded-xl" src="/images/article-0.png" alt="Article Image" width={250} height={200} />
...
const Article2 = () => {
  return (
    <Link className="flex flex-col" href="/articles/the-shift-from-manual-to-automated-testing-challenges-and-solutions">
      <Image className="w-full max-h-48 object-cover rounded-xl" src="/images/article-img1.png" alt="Article Image" width={250} height={200} />
...
const Article3 = () => {
  return (
    <Link className="flex flex-col" href="/articles/testing-in-devops-how-qa-engineers-can-keep-up-with-the-speed-of-continuous-integration">
      <Image className="w-full max-h-48 object-cover rounded-xl" src="/images/article-img2.png" alt="Article Image" width={250} height={200} />
...
const Article4 = () => {
  return (
    <Link className="flex flex-col" href="/articles/who-is-a-scrum-master">
      <Image className="w-full max-h-48 object-cover rounded-xl" src="/images/article-img3.png" alt="Article Image" width={250} height={200} />

        ...
        <Slider {...settings} className="mx-auto lg:mx-0 w-full flex">
          <div className="mx-auto">
            <div className="flex flex-col lg:flex-row lg:gap-8">
              ...
              <article className="flex flex-col w-full lg:max-w-550 my-auto mr-auto">
                <h4 className="text-xl lg:text-3xl mx-auto lg:mx-0 lg:mr-auto font-550 bg-gradient-to-r max-w-550 from-slate-700 to-purple-400 text-transparent bg-clip-text mb-4">Blessing Arigbe</h4>
          ...
          <div className="mx-auto">
            <div className="flex flex-col lg:flex-row lg:gap-8">
              ...
              <article className="flex flex-col w-full lg:max-w-550 my-auto mr-auto">
                <h4 className="text-xl lg:text-3xl mx-auto lg:mx-0 lg:mr-auto font-550 bg-gradient-to-r max-w-550 from-slate-700 to-purple-400 text-transparent bg-clip-text mb-4">Sandra Alutu</h4>
                <div className="text-lg text-primary font-light text-center lg:text-left mb-4 w-full">

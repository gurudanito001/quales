...
const CohortSignup = ()=>{
  return(
    <section className="bg-section-blue text-section-red px-5 lg:px-28 py-20 lg:py-36 flex flex-col md:flex-row mb-10">
      ...
      <Link href="https://calendly.com/ayobami-/discuss-about-prospective-talent?month=2024-07" target="_blank" className="btn bg-gray-900 text-white rounded-full px-8 mr-auto md:mr-0 md:ml-auto mt-8">Register for Course</Link>
    </section>
  )
}

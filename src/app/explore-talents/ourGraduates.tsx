    ...
    <section className="bg-white px-5 lg:px-28 py-10 flex flex-col-reverse md:flex-row items-center">
      ...
      <article className="text-base-content md:w-1/2 flex flex-col">
        <header className="flex flex-col">
          <h3 className="text-2xl xl:text-3xl font-semibold bg-gradient-to-r max-w-550 from-slate-700 to-purple-400 inline text-transparent bg-clip-text mx-auto md:mx-0"> Our Graduates Work </h3>
